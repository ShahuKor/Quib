  ...
  return (
    <div className="group relative bg-linear-to-br from-gray-200/0.08 to-gray-400/0.03 p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
      ...
      <div className="relative flex items-start gap-3">
        ...
        <p className="text-md lg:text-md text-muted-foreground/90 leading-relaxed">
          {text}
        </p>
      </div>
    </div>
...
const RegularPoint = ({ point }: { point: string }) => {
  return (
    <div className="group relative bg-linear-to-br from-gray-200/0.08 to-gray-400/0.03 p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
      ...
      <p className="relative text-md lg:text-md text-muted-foreground/90 leading-relaxed text-left">
        {point}
      </p>
    </div>
  );
